...
A Next.js 15 + Supabase product directory. Users browse, search, filter, and submit tools/SaaS products. The stack is Next.js App Router, Supabase (auth + DB + storage), Tailwind CSS, shadcn/ui, framer-motion.
